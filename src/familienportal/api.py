...
DEFAULT_ROLES: dict[str, str] = {
    "Administrator": "*",
    "Erwachsene": "dashboard.read,calendar.*,tasks.*,documents.read,chat.*",
    "Kind": "dashboard.read,calendar.read,tasks.read,tasks.update,chat.use",
    "Gast": "dashboard.read,calendar.read",
}
