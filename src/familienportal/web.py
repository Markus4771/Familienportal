...
def dashboard(request: Request, db: Session = Depends(get_db)):
    ...
    modules = [
        {"name": "Nachrichten", "icon": "bi-newspaper", "status": "Geplant"},
        {"name": "Kleinanzeigen", "icon": "bi-shop", "status": "Geplant"},
        {"name": "Cloud", "icon": "bi-cloud", "status": "Nextcloud-Connector"},
        {"name": "E-Mail", "icon": "bi-envelope", "status": "Mailcow-Connector"},
