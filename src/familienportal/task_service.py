...
def create_task(
    ...
    *,
    ...
    task = FamilyTask(
        family_id=family_id,
        creator_user_id=_family_user(db, family_id, creator_user_id),
        household_id=_family_household(db, family_id, household_id),
        assignee_user_id=_family_user(db, family_id, assignee_user_id),
